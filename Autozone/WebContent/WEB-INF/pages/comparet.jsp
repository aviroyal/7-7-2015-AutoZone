...
<div class="col-md-12">
 ...
 <div class="panel panel-default">
    ...
    <form:form method = "POST" action = "/Autozone/comparet" modelAttribute = "compare">
...
<div class="input-group">
  <span class="input-group-addon" id="sizing-addon2">Select Truck Name</span>
<form:select class="form-control" id="sel1" required="true" path = "carname">
 <c:forEach items="${allcars}" var="type">

    <option value = "${type.truckname}">${type.truckname}</option>
    </c:forEach>
  </form:select>
</div>
<div class="input-group">
...
<br>
<a href="/Autozone/comparet"><form:button type="submit" class="btn btn-danger pull-left">Compare</form:button></a>
