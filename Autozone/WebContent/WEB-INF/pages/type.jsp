...
<br>     
<br>
<p class="info"><strong>SEDAN</strong> </p>                 <ul id="carousel" class="elastislide-list">
...
<br>
<br>
<p class="info"><strong>COUPE</strong> </p> <ul id="carouse2" class="elastislide-list">
...
<p class="info"><strong>SUV</strong> </p>                <ul id="carouse3" class="elastislide-list">
                <h1>SUV</h1>
