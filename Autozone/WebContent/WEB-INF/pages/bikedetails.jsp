        ...
        <p><a href="#" class="btn btn-primary" role="button">Click This Button to Add Review</a> <a href="#" class="btn btn-default" role="button">Button</a></p>
				...
				<div class="container demo-4">
					...
					<div class="main">
						...
						<p>
							<strong>${getcar.bikename } ${getcar.bikemodel } Rating:
								${getcar.rating }/5 </strong>
						</p>
						<p class="info">
						<div align="left"><b>Description: </b><br></div><br><strong><pre>${getcar.bikedesc}</pre></strong>
					
						<br>	 
						<a href="/Autozone/add1?id=${getcar.bike_id}" class="btn btn-info"
